...
const Dashboard = () => {
  ...
  if (!isAuthenticated) {
    return (
      <div style={{ padding: '40px 20px', textAlign: 'center' }}>
        <p style={{ fontSize: '18px', color: '#666' }}>Please login to view dashboard</p>
      </div>
    );
  }
  ...
  if (loading) {
    return (
      <div style={{ padding: '40px 20px', textAlign: 'center' }}>
        <p style={{ fontSize: '18px', color: '#666' }}>⏳ Loading your profile...</p>
      </div>
    );
  }
  ...
  if (!profile) {
    return (
      <div style={{ padding: '40px 20px', textAlign: 'center' }}>
        <p style={{ color: '#d32f2f', fontSize: '16px' }}>❌ Profile not found</p>
      </div>
    );
  }
